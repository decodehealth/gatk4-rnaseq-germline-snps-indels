...
def handle_gatk_halotypecaller():
    rjson = request.get_json()
    ## get vals
    path_to_input_bam = rjson["input_bam_path"]
...
def handle_gatk_variantfiltration():
    rjson = request.get_json()
    ## get vals
    path_to_input_bam = rjson["input_bam_path"]
